...
function Microsoft() {
    ...
    useEffect(() => {
        ...
        const releaseKeys = (e: KeyboardEvent) => {
            if (e.key === 'Control') {
        ...
        window.addEventListener('keyup', releaseKeys, { capture: true });
        ...
        return () => {
            ...
            window.removeEventListener('keyup', releaseKeys, { capture: true });
